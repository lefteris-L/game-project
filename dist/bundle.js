...
/* harmony import */ var _states__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
var canvasWidth = canvas.width = 575;
var canvasHeight = canvas.height = 523;
var playerImage = new Image();
playerImage.src = 'https://www.frankslaboratory.co.uk/downloads/shadow_dog.png';
var spriteWidth = 6876;
var spriteHeight = 5230;
var gameFrame = 0;
var staggerFrames = 5;
var spriteAnimations = [];
_states__WEBPACK_IMPORTED_MODULE_1__["default"].forEach(function (state, i) {
  var frames = {
    loc: []
  };
  for (var j = 0; j < state.frames; j++) {
    var x = j * canvasWidth;
    var y = i * canvasHeight;
    frames.loc.push({
      x: x,
      y: y
    });
...
var animate = function animate() {
  ...
  var frameX = canvasWidth * -position;
